...
const reactionMap: Record<string, string> = {
  ...
  'music': '🎵', 'song': '🎶', 'dance': '💃', 'party': '🎉',
  'food': '🍕', 'eat': '🍽️', 'drink': '🥤', 'cheers': '🥂',
  'coffee': '☕', 'tea': '🍵', 'beer': '🍺', 'wine': '🍷',
  'cat': '🐱', 'dog': '🐶', 'pet': '🐾', 'animal': '🦁',
  'flower': '🌸', 'nature': '🌿', 'sun': '☀️', 'moon': '🌙',
  'rain': '🌧️', 'snow': '❄️', 'fire': '🔥', 'water': '💧',
  'car': '🚗', 'bus': '🚌', 'train': '🚆', 'plane': '✈️',
  'home': '🏠', 'work': '💼', 'school': '🏫', 'gym': '🏋️',
  'game': '🎮', 'play': '▶️', 'pause': '⏸️', 'stop': '⏹️',
  'heart': '❤️', 'love': '❤️', 'kiss': '😘', 'hug': '🤗',
  'smile': '😊', 'sad': '😢', 'cry': '😭', 'angry': '😠',
  'laugh': '😂', 'lol': '😂', 'rofl': '🤣', 'dead': '💀',
  'sick': '🤢', 'sleepy': '😴', 'bored': '😐', 'scared': '😱',
  'shocked': '😲', 'wow': '😲', 'omg': '😱', 'confused': '😕',
  'nerd': '🤓', 'sunglasses': '😎', 'clown': '🤡', 'ghost': '👻',
  'alien': '👽', 'robot': '🤖', 'poop': '💩', 'devil': '😈',
  'angel': '😇', 'thumbsup': '👍', 'thumbsdown': '👎', 'clap': '👏',
  ...
  'ring': '💍', 'diamond': '💎', 'crown': '👑', 'gift': '🎁',
  'balloon': '🎈', 'confetti': '🎊', 'medal': '🥇', 'trophy': '🏆'
};
