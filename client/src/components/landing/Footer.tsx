        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
          <div className="max-w-xs">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-bold text-slate-900">Aastha.</span>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-12 lg:gap-24">
            <div>
              ...
              <ul className="space-y-4 text-slate-500">
                ...
                <li><a href="#" className="hover:text-violet-600 transition-colors">Testimonials</a></li>
                <li><a href="#" className="hover:text-violet-600 transition-colors">Download</a></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center text-slate-500 hover:bg-violet-100 hover:text-violet-600 transition-all">
                  <Twitter size={18} />
                </a>
                <a href="#" className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center text-slate-500 hover:bg-violet-100 hover:text-violet-600 transition-all">
                  <Instagram size={18} />
